...
entity mean_pipelined_tb is
end entity;

architecture mean_pipelined_tb_arch of mean_pipelined_tb is
    -------------------------------------------------------------------------------------
    -- CONSTANTS
    -------------------------------------------------------------------------------------
...
configuration mean_pipelined_tb_conf of mean_pipelined_tb is
    for mean_pipelined_tb_arch
        for UUT : mean
            use configuration LIB_RTL.mean_pipelined_conf;
        end for;
    end for;
end configuration mean_pipelined_tb_conf;