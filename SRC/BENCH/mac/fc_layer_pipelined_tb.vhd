...
entity fc_layer_pipelined_tb is
end entity;

architecture fc_layer_pipelined_tb_arch of fc_layer_pipelined_tb is
    -------------------------------------------------------------------------------------
    -- CONSTANTS
    -------------------------------------------------------------------------------------
...
configuration fc_layer_pipelined_tb_conf of fc_layer_pipelined_tb is
    for fc_layer_pipelined_tb_arch
        for UUT : fc_layer
            use configuration LIB_RTL.fc_layer_pipelined_conf;
        end for;
    end for;
end configuration fc_layer_pipelined_tb_conf;