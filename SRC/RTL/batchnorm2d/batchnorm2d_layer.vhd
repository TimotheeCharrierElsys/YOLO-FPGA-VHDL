...
entity batchnorm2d_layer is
    ...
    port (
        ...
        o_data       : out std_logic_vector(2 * BITWIDTH - 1 downto 0); --! Channel-wise output data
...
architecture batchnorm2d_layer_arch of batchnorm2d_layer is
    ...
    signal r_end_computation_part : std_logic;                                 --! Signal to start the end of the computation (i.e. update output)
